<?php
    ...
    $router->get('/about', function() use($twig) {
     ...
     $router->get('/contact', function() use($twig) {
       echo $twig->render('contact.twig', ['navigation' => array('quem somos' => '/about', 'investimentos' => '/investments', 'contatos' => '/contact', 'login' => 'login', 
                                         'abra sua conta' => '/signup')]);
    });
     $router->get('/investments', function() use($twig) {
       echo $twig->render('investments.twig', ['navigation' => array('quem somos' => '/about', 'investimentos' => '/investments', 'contatos' => '/contact', 'login' => 'login', 
                                         'abra sua conta' => '/signup')]);
    });

$router->get('/signup', function() use($twig) {
       echo $twig->render('sign_up.twig', ['navigation' => array('quem somos' => '/about', 'investimentos' => '/investments', 'contatos' => '/contact', 'login' => 'login', 
                                         'abra sua conta' => '/signup')]);
    });
