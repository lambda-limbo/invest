...
--
DELIMITER //
CREATE  PROCEDURE P_INSERT_STOCK(IN STOCK_MINIMIUM DOUBLE, IN STOCK_MAXIMUN DOUBLE, 
                                 IN STOCK_OPEN_VALUE DOUBLE, IN STOCK_CLOSE_VALUE DOUBLE, 
                                 IN STOCK_VALUE DOUBLE, IN TB_COMPANY_COMPANY_PK INT)
                            
BEGIN
    INSERT INTO TB_STOCK (STOCK_MINIMIUM, STOCK_MAXIMUN, STOCK_OPEN_VALUE, STOCK_CLOSE_VALUE, STOCK_VALUE, TB_COMPANY_COMPANY_PK)
    VALUES (STOCK_MINIMIUM, STOCK_MAXIMUN, STOCK_OPEN_VALUE, STOCK_CLOSE_VALUE, STOCK_VALUE, TB_COMPANY_COMPANY_PK);
END
//
