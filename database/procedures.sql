...
DELIMITER //
CREATE  PROCEDURE P_INSERT_USER(NAME VARCHAR(100), LOGIN VARCHAR(20), PASSWORD VARCHAR(255), CPF VARCHAR(20), EMAIL VARCHAR(50),
...
BEGIN
    ...
    VALUES (NAME, WALLET, PASSWORD, LOGIN, CPF, EMAIL, BIRTH, USER_WALLET, PHONE , 0);
END
//
...
BEGIN
    INSERT INTO TB_USER (USER_NAME, USER_LOGIN, USER_PASSWORD, USER_CPF, USER_EMAIL, USER_PHONE, USER_BIRTH, USER_WALLET, USER_ADM)
    VALUES (NAME, WALLET, PASSWORD, LOGIN, CPF, EMAIL, BIRTH, USER_WALLET, PHONE , 1);
END
//
