...
BEGIN
  ...
  WHERE 
    (S.STOCK_PK = T.FK_STOCK_PK)
    AND (C.COMPANY_PK = S.FK_COMPANY_PK)
    AND T.FK_USER_PK = CODIGO;
END
//
...
BEGIN
    SELECT SUM(TRANSACTION_TOTAL)  AS VALOR FROM TB_TRANSACTION WHERE FK_USER_PK = PK_CODE AND TRANSACTION_TYPE = 'Compra';
END
//
...
BEGIN
    SELECT SUM(TRANSACTION_TOTAL) AS VALOR FROM TB_TRANSACTION WHERE FK_USER_PK = PK_CODE AND TRANSACTION_TYPE = 'Venda';
END
//
